...
key = tk.Tk()
key.title('On Screen Keyboard - Dvorak')
...
def display():
    ...
    if (is_shift):
        ...
        curly_l.grid(row=1, column=11, ipadx=6, ipady=10)

        curly_r = ttk.Button(key, text='}', width=6,
                             command=lambda: press('}'))
        curly_r.grid(row=1, column=12, ipadx=6, ipady=10)
        ...
        tab_button = ttk.Button(key, text='Tab', width=6,
                                command=lambda: press('\t'))
        tab_button.grid(row=2, column=0, columnspan=1, ipadx=55, ipady=10)

        quotation = ttk.Button(key, text='"', width=6,
                               command=lambda: press('"'))
        quotation.grid(row=2, column=1, ipadx=6, ipady=10)

        ang_l = ttk.Button(key, text='<', width=6, command=lambda: press('<'))
        ang_l.grid(row=2, column=2, ipadx=6, ipady=10)

        ang_r = ttk.Button(key, text='>', width=6, command=lambda: press('>'))
        ang_r.grid(row=2, column=3, ipadx=6, ipady=10)
        ...
        pipe.grid(row=2, column=13, ipadx=6, ipady=10)
        ...
        under.grid(row=3, column=10, ipadx=6, ipady=10)

        enter = ttk.Button(key, text='Enter', width=6,
                           command=lambda: press('\n'))
        enter.grid(row=3, column=11, columnspan=2, ipadx=55, ipady=10)

        # Fourth Row Buttons

        shift = ttk.Button(key, text='Shift', width=6, command=Shift)
        shift.grid(row=4, column=0, columnspan=1, ipadx=55, ipady=10)

        colon = ttk.Button(key, text=':', width=6,
                           command=lambda: press(':'))
        colon.grid(row=4, column=1, ipadx=6, ipady=10)

        Q = ttk.Button(key, text='Q', width=6, command=lambda: press('Q'))
        Q.grid(row=4, column=2, ipadx=6, ipady=10)

        J = ttk.Button(key, text='J', width=6, command=lambda: press('J'))
        J.grid(row=4, column=3, ipadx=6, ipady=10)

        K = ttk.Button(key, text='K', width=6, command=lambda: press('K'))
        K.grid(row=4, column=4, ipadx=6, ipady=10)

        X = ttk.Button(key, text='X', width=6, command=lambda: press('X'))
        X.grid(row=4, column=5, ipadx=6, ipady=10)
        ...
        W.grid(row=4, column=8, ipadx=6, ipady=10)

        V = ttk.Button(key, text='V', width=6, command=lambda: press('V'))
        V.grid(row=4, column=9, ipadx=6, ipady=10)

        Z = ttk.Button(key, text='Z', width=6, command=lambda: press('Z'))
        Z.grid(row=4, column=10, ipadx=6, ipady=10)
       
        clear = ttk.Button(key, text='Clear', width=6, command=Clear)
        clear.grid(row=4, column=11, columnspan=2, ipadx=55, ipady=10)
        ...
        sq_l.grid(row=1, column=11, ipadx=6, ipady=10)

        sq_r = ttk.Button(key, text=']', width=6, command=lambda: press(']'))
        sq_r.grid(row=1, column=12, ipadx=6, ipady=10)
        ...
        dot.grid(row=2, column=3, ipadx=6, ipady=10)
        ...
        back_slash = ttk.Button(key, text='\\', width=6,
                                command=lambda: press('\\'))
        back_slash.grid(row=2, column=13, ipadx=6, ipady=10)
        ...
        minus.grid(row=3, column=10, ipadx=6, ipady=10)
        ...
        semi_co = ttk.Button(key, text=';', width=6,
                             command=lambda: press(';'))
        semi_co.grid(row=4, column=1, ipadx=6, ipady=10)
