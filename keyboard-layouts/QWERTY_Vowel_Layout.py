...
def Caps():
    if (is_caps == False):
        ...
        vertSlash = ttk.Button(key, text='|', width=6,
                                command=lambda: press('|'))
        vertSlash.grid(row=2, column=13, ipadx=6, ipady=10)
        ...
        space = ttk.Button(key, text='Space', width=6,
                            command=lambda: press(' '))
        space.grid(row=5, column=3, columnspan=9, ipadx=350, ipady=10)
        ...
        Q = ttk.Button(key, text='q', width=6, command=lambda: press('q'))
        Q.grid(row=2, column=1, ipadx=6, ipady=10)

        W = ttk.Button(key, text='w', width=6, command=lambda: press('w'))
        W.grid(row=2, column=2, ipadx=6, ipady=10)

        E = ttk.Button(key, text='e', width=6, command=lambda: press('e'), style= 'JS.TButton')
        E.grid(row=2, column=3, ipadx=6, ipady=10)

        R = ttk.Button(key, text='r', width=6, command=lambda: press('r'))
        R.grid(row=2, column=4, ipadx=6, ipady=10)

        T = ttk.Button(key, text='t', width=6, command=lambda: press('t'))
        T.grid(row=2, column=5, ipadx=6, ipady=10)

        Y = ttk.Button(key, text='y', width=6, command=lambda: press('y'))
        Y.grid(row=2, column=6, ipadx=6, ipady=10)

        U = ttk.Button(key, text='u', width=6, command=lambda: press('u'), style= 'JS.TButton')
        U.grid(row=2, column=7, ipadx=6, ipady=10)

        I = ttk.Button(key, text='i', width=6, command=lambda: press('i'), style= 'JS.TButton')
        I.grid(row=2, column=8, ipadx=6, ipady=10)

        O = ttk.Button(key, text='o', width=6, command=lambda: press('o'), style= 'JS.TButton')
        O.grid(row=2, column=9, ipadx=6, ipady=10)

        P = ttk.Button(key, text='p', width=6, command=lambda: press('p'))
        P.grid(row=2, column=10, ipadx=6, ipady=10)

        sq_l = ttk.Button(key, text='[', width=6, command=lambda: press('['))
        sq_l.grid(row=2, column=11, ipadx=6, ipady=10)

        sq_r = ttk.Button(key, text=']', width=6, command=lambda: press(']'))
        sq_r.grid(row=2, column=12, ipadx=6, ipady=10)
            
        backslash = ttk.Button(key, text='\\', width=6, command=lambda: press('\\'))
        backslash.grid(row=2, column=13, ipadx=6, ipady=10)
            # Third Row Buttons.
        ...
        D = ttk.Button(key, text='d', width=6, command=lambda: press('d'))
        D.grid(row=3, column=3, ipadx=6, ipady=10)

        F = ttk.Button(key, text='f', width=6, command=lambda: press('f'))
        F.grid(row=3, column=4, ipadx=6, ipady=10)

        G = ttk.Button(key, text='g', width=6, command=lambda: press('g'))
        G.grid(row=3, column=5, ipadx=6, ipady=10)

        H = ttk.Button(key, text='h', width=6, command=lambda: press('h'))
        H.grid(row=3, column=6, ipadx=6, ipady=10)

        J = ttk.Button(key, text='j', width=6, command=lambda: press('j'))
        J.grid(row=3, column=7, ipadx=6, ipady=10)

        K = ttk.Button(key, text='k', width=6, command=lambda: press('k'))
        K.grid(row=3, column=8, ipadx=6, ipady=10)

        L = ttk.Button(key, text='l', width=6, command=lambda: press('l'))
        L.grid(row=3, column=9, ipadx=6, ipady=10)

        semi_co = ttk.Button(key, text=';', width=6,
                                command=lambda: press(';'))
        semi_co.grid(row=3, column=10, ipadx=6, ipady=10)

        quotation = ttk.Button(key, text="'", width=6,
                                command=lambda: press('"'))
        quotation.grid(row=3, column=11, ipadx=6, ipady=10)

        back_slash = ttk.Button(key, text='\\', width=6,
                                    command=lambda: press('\\'))
        back_slash.grid(row=3, column=12, ipadx=6, ipady=10)

        enter = ttk.Button(key, text='Enter', width=6,
                            command=lambda: press('\n'))
        enter.grid(row=3, column=13, columnspan=2,ipadx=30, ipady=10)
