...
def display():
    ...
    if (is_shift):
        ...
        U.grid(row=2, column=9, ipadx=6, ipady=10)

        Y = ttk.Button(key, text='Y', width=6, command=lambda: press('Y'))
        Y.grid(row=2, column=10, ipadx=6, ipady=10)

        colon = ttk.Button(key, text=':', width=6,
                           command=lambda: press(':'))
        colon.grid(row=2, column=11, ipadx=6, ipady=10)
        ...
        pipe.grid(row=3, column=14, ipadx=6, ipady=10)

        # Third Row Buttons
        backspace = ttk.Button(
            key, text='<---', width=6, command=Backspace)
        backspace.grid(row=1, column=0, ipadx=6, ipady=10)
        ...
        R.grid(row=3, column=2, ipadx=6, ipady=10)
        ...
        E.grid(row=3, column=8, ipadx=6, ipady=10)

        I = ttk.Button(key, text='I', width=6, command=lambda: press('I'))
        I.grid(row=3, column=9, ipadx=6, ipady=10)

        O = ttk.Button(key, text='O', width=6, command=lambda: press('O'))
        O.grid(row=3, column=10, ipadx=6, ipady=10)
        ...
        K.grid(row=4, column=7, ipadx=6, ipady=10)
        ...
        shift = ttk.Button(key, text='Shift', width=6, command=Shift)
        shift.grid(row=4, column=12, columnspan=2, ipadx=55, ipady=10)
        ...
        semi_co = ttk.Button(key, text=';', width=6,
            command=lambda: press(';'))
        semi_co.grid(row=2, column=11, ipadx=6, ipady=10)
        ...
        back_slash = ttk.Button(key, text='\\', width=6,
            command=lambda: press('\\'))
        back_slash.grid(row=2, column=14, ipadx=6, ipady=10)
